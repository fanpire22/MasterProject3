...
namespace CaronteFX
{
  ...
  public class CNTriggerByDetector : CNTrigger
  {
    ...
    public override void CloneData(CommandNode original)
    {
      ...
      CNTriggerByDetector originalTbd = (CNTriggerByDetector)original;

      fieldA_ = originalTbd.FieldA.DeepClone();
      fieldB_ = originalTbd.FieldB.DeepClone();

      triggerForInvolvedBodies_ = originalTbd.TriggerForInvolvedBodies;
    }
