...
namespace CaronteFX
{
  ...
  public class CNSelector : CNMonoField
  {
    ...
    public override void CloneData(CommandNode original)
    {
      ...
      CNSelector originalSl = (CNSelector)original;

      selectorGO_    = originalSl.selectorGO_;
      selectionMode_ = originalSl.selectionMode_;

      frontierPieces_ = originalSl.frontierPieces_;
      complementary_  = originalSl.complementary_;
    }
