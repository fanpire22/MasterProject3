...
namespace CaronteFX
{
  ...
  public class CNFracture : CNMonoField
  {
    ...
    [SerializeField]
    bool doUseInternalRadius_ = false;
    public bool DoUseInternalRadius
    {
      get { return doUseInternalRadius_; }
      set { doUseInternalRadius_ = value; }
    }

    [SerializeField]
    public bool doUseInternalRadiusFoldout_ = false;
    public bool DoUseInternalRadiusFoldout
    {
      get { return doUseInternalRadiusFoldout_; }
      set { doUseInternalRadiusFoldout_ = value; }
    }
    ...
    [SerializeField]
    private bool doRestrictFractureZoneFoldout_ = false;
    public bool DoRestrictFractureZoneFoldout
    {
      get { return doRestrictFractureZoneFoldout_; }
      set { doRestrictFractureZoneFoldout_ = value; }
    }
    ...
    [SerializeField]
    private bool doNoiseFoldout_ = false;
    public bool DoNoiseFoldout
    {
      get { return doNoiseFoldout_; }
      set { doNoiseFoldout_ = value; }
    }
    ...
    public override void CloneData(CommandNode original)
    {
      ...
      CNFracture originalFr = (CNFracture)original;

      if (originalFr.fieldRestrictionGeometry_ != null)
      {
        fieldRestrictionGeometry_ = originalFr.fieldRestrictionGeometry_.DeepClone();
      }    

      if (originalFr.fieldSteeringGeometry_ != null)
      {
        fieldSteeringGeometry_ = originalFr.fieldSteeringGeometry_.DeepClone();
      }

      chopMode_                   = originalFr.chopMode_;
      doGlobalPattern_            = originalFr.doGlobalPattern_;
      nDesiredPieces_             = originalFr.nDesiredPieces_;
      seed_                       = originalFr.seed_;
      chopGeometry_               = originalFr.chopGeometry_;
      gridResolution_             = originalFr.gridResolution_;
      focusMode_                  = originalFr.focusMode_;
      densityRate_                = originalFr.densityRate_;
      transitionLength_           = originalFr.transitionLength_;
      referenceSystem_            = originalFr.referenceSystem_;
      referenceSystemAxis_        = originalFr.referenceSystemAxis_;
      rays_number_                = originalFr.rays_number_;
      rays_rateRand_              = originalFr.rays_number_;
      rings_numberInsideAnnulus_  = originalFr.rings_numberInsideAnnulus_; 
      rings_intRadius_            = originalFr.rings_numberInsideAnnulus_;
      rings_extRadius_            = originalFr.rings_extRadius_;
      rings_intTransitionLength_  = originalFr.rings_intTransitionLength_;
      rings_extTransitionLength_  = originalFr.rings_extTransitionLength_;
      rings_intTransitionDecay_   = originalFr.rings_intTransitionDecay_;
      rings_extTransitionDecay_   = originalFr.rings_extTransitionDecay_;
      rings_rateRand_             = originalFr.rings_rateRand_;
      doCentralPiece_             = originalFr.doCentralPiece_;
      noiseRate_                  = originalFr.noiseRate_;
      twistRate_                  = originalFr.twistRate_;
      doExtrusionEffect_          = originalFr.doExtrusionEffect_;
      doCoordinate_               = originalFr.doCoordinate_;
      arrGameObject_chopped_      = originalFr.arrGameObject_chopped_;
      interiorMaterial_           = originalFr.interiorMaterial_;

      hideParentObjectsAuto_      = originalFr.hideParentObjectsAuto_;
      restrictFractureZone_       = originalFr.restrictFractureZone_;
      cropGeometry_               = originalFr.cropGeometry_;
      cropMode_                   = originalFr.cropMode_;
      frontierPieces_             = originalFr.frontierPieces_;
      weldInOnePiece_             = originalFr.weldInOnePiece_;

      doNoise_                    = originalFr.doNoise_;
      noiseResolutionRate_        = originalFr.noiseResolutionRate_;
      noiseReliefAmplitudeRate_   = originalFr.noiseReliefAmplitudeRate_;
      noiseReliefSerrationRate_   = originalFr.noiseReliefSerrationRate_; ;
      noiseSeed0_                 = originalFr.noiseSeed0_;
      noiseDoExtrusionEffect_     = originalFr.noiseDoExtrusionEffect_;

      internalFacesSmoothingAngle_ = originalFr.internalFacesSmoothingAngle_;
      interiorFacesTiling_         = originalFr.interiorFacesTiling_;
      interiorFacesOffset_         = originalFr.interiorFacesOffset_;

      generateNewSubmeshForInteriorFaces_ = originalFr.generateNewSubmeshForInteriorFaces_;
    }
