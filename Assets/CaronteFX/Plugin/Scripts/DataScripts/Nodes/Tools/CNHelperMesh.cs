...
namespace CaronteFX
{
  ...
  public class CNHelperMesh : CommandNode
  {
    ...
    public override void CloneData(CommandNode original)
    {
      ...
      CNHelperMesh originalHm = (CNHelperMesh)original;

      RandomSeed = originalHm.RandomSeed;
      Resolution = originalHm.Resolution;
      NBumps     = originalHm.NBumps;
      RadiusMin  = originalHm.RadiusMin;
      RadiusMax  = originalHm.RadiusMax;
    }
