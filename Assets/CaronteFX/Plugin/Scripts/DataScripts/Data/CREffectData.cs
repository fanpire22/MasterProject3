...
namespace CaronteFX
{
  ...
  public class CREffectData
  {
    ...
    public bool byUserAnimationSamplingRate_ = false;
    public int animationSamplingRate_ = 30;

    public bool doSleeping_               = true;
    public bool doBullet_                 = true;
    public bool doHit_                    = true;
    public bool doRgBinaryPLConservation_ = false;
    #endregion
    //-----------------------------------------------------------------------------------
    public void SetDefault()
    {
      ...
      byUserAnimationSamplingRate_ = false;
      animationSamplingRate_       = 30;
    }
    //-----------------------------------------------------------------------------------
    ...
    //-----------------------------------------------------------------------------------
    public uint GetAnimationSamplingRate()
    {
      if (byUserAnimationSamplingRate_)
      {
        return (uint)animationSamplingRate_;
      }
      else
      {
        return (uint)frameRate_;
      }
    }
    //-----------------------------------------------------------------------------------
  }
