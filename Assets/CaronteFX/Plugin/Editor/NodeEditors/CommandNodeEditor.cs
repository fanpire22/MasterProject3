...
namespace CaronteFX
{
  ...
  public abstract class CommandNodeEditor : IView, IFieldEditor
  {
    ...
    //-----------------------------------------------------------------------------------
    public void RenderFieldObjects( string labelText, float labelWidth, CNFieldController fieldController, bool enabled, bool showScope, CNFieldWindow.Type windowType)
    {
      if (objects_rect_width == 1)
      {
        CarManagerEditor.RepaintIfOpen();
      ...
      EditorGUILayout.LabelField(labelText, GUILayout.MaxWidth(labelWidth));
