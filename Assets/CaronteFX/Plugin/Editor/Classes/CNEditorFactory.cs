  ...
  public class CNEditorFactory
  {
    ...
    private void InitDictionaries()
    {
      @switchNodeEditor = new Dictionary<Type, CRCommandNodeEditorCreationDel> {
             ...
             { typeof(CNPivotModifier),     (CommandNode node) => 
                                            {
                                              CNPivotModifier pmNode = (CNPivotModifier) node;
                                              CNPivotModifierEditor pmEditor = new CNPivotModifierEditor(pmNode, new CommandNodeEditorState());
                                              pmEditor.Init();
                                              return pmEditor;
                                            } },
        ...
        @switchDragAction  = new Dictionary<Type, CNCommandNodeDragAction> {
           ...
           { typeof(CNPivotModifier),     (CommandNodeEditor cnEditor, UnityEngine.Object[] draggedObjects ) => 
                                          {
                                            CNMonoFieldEditor mfEditor = (CNMonoFieldEditor)cnEditor;
                                            mfEditor.AddGameObjects( draggedObjects, true );
                                          } },
