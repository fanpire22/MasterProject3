...
public class CustomDragData
{
  ...
  public CarListBox originalList;
}

public class CarListBox : IListView
{ 
  ...
  //----------------------------------------------------------------------------------
  public CarListBox( IListController controller, string dragDropIdentifier, bool isTreeList )
  {
  ...
  { 
    ...
    ProccessEventsPostDraw( ev, listBox );  
  ...
  //----------------------------------------------------------------------------------
  private void ProccessEventsPostDraw( Event ev, Rect listBox )
  {
    switch (ev.type)
    {  
